...
def count_objects_with_yolox(img_path, weight_path, vocabulary=None, output_dir='output', outlier_threshold=3.0):
    ...
    # Always use TinyCLIP classification
    use_clip = True
    ...
    if outputs[0] is not None:
        ...
        # Stage 2: Classification (always use TinyCLIP)
        print(f"\n{'='*70}")
        ...
        print(f"\n🔍 Classifying {n} detections using TinyCLIP...")
        ...
        for i in range(n):
            ...
            if (i + 1) % 10 == 0 or (i + 1) == n:
                print(f"  Progress: {i+1}/{n} detections classified")
        ...
        # Create text report (always TinyCLIP)
        ...
        with open(report_path, 'w') as f:
            ...
            f.write(f"Classifier: TinyCLIP (wkcn/TinyCLIP-ViT-8M-16-Text-3M-YFCC15M)\n")
